...
const selectors = require('../selectors/PiedmontCancerInstitute.json');

async function scrapePiedmontCancerInstitute() {
    ...
    try {
        ...
        for (let i = 0; i < cards.length; i++) {
            ...
            await page.waitForSelector(selectors.addressLink, { timeout: 30000 }).catch(() => console.warn('addressMapsLink selector not found'));
...
module.exports = { scrapePiedmontCancerInstitute };