...
const selectors = require('../selectors/Centertx.json');

async function scrapeCentertx() {
    ...
    try {
        ...
        for (let i = 0; i < cards.length; i++) {
            ...
            await page.waitForSelector(selectors.clinicName, { timeout: 60000 }).catch(() => console.warn('Clinic name selector not found'));
